...
<body class="overflow-x-hidden">
  <div class="container-fluid background-gradient-image vh-100">
    ...
    <nav class="navbar navbar-expand-lg container py-3">
      <div class="container-fluid">
        <!-- Logo -->
        <a class="navbar-brand text-white fs-1 fw-bold" href="./index.php">Logi<span class="text-warning">Sync</span></a>
    ...
    <div class="text-center mt-sm-1 height d-flex flex-column justify-content-center align-items-center">
      ...
      <a href="tel:+12345678900" class="text-white text-decoration-none fs-1 fw-bold"><i class="fa-solid fa-mobile-screen"></i> +91 7044904397</a>
  ...
  <div>
    <div class="bg-warning container-fluid mx-auto row p-sm-2 p-md-5">
      <div class="col-12 col-md-6 p-5">
        <p class="fw-bold m-1 mx-0">Best in Logistic and Good Transports</p>
        <h3 class="fw-bolder">Trusted Services in India</h3>
        <p>
          "Welcome to LogiSync, your trusted logistics partner! Experience a 
          seamless journey through the city with our efficient, stylish, and 
          expertly managed services. From swift deliveries to reliable transportation, 
          we ensure your goods reach their destination on time and in perfect condition. 
          Let’s transform logistics into a smooth and memorable experience together!"
        </p>
      </div>
      ...
      <div class="row justify-content-center gap-5 mb-5">
        ...
        <div class="col-12 col-md-4 border d-flex justify-content-between align-items-start gap-3 p-4 white-variant rounded-1">
          ...
          <div>
            ...
            <p class="">
              "Swift bookings, seamless rides! With our tranpsort services,
      ...
      <div class="row justify-content-center gap-5">
        ...
        <div class="col-12 col-md-4 border d-flex justify-content-between align-items-start gap-3 p-4 white-variant rounded-1">
          ...
          <div>
            <p class="mb-2 fw-bold">Fast Booking</p>
            <p class="">
              "Swift bookings, seamless rides! With our tranport services,
              booking a ride is as quick as a tap. Experience instant
              reservations, hassle-free scheduling, and prompt pickups. Your
              journey starts with a click – book fast, ride faster
            </p>
  ...
  <div class="bg-warning text-center p-5">
    ...
    <a href="tel:+123 4567 8900" class="text-decoration-none text-black fs-1 fw-bolder"><i class="fa-solid fa-mobile-screen"></i> +917044904397</a>
  </div>
  ...
  <div class="bg-black">
    <div class="row gap-2 p-5">
      <div class="col-12 col-md-4">
        ...
        <p class="text-color">
          Meet Logi<span class="text-warning">Sync</span> – your go-to for
          swift, safe rides! With a commitment to excellence, we offer
          seamless transport of goods with a reliable fleet and professional drivers. Your
