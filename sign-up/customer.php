...
<head>
  ...
  <title>Passenger's Sign-Up Page | LogiSync</title>
...
<body class="overflow-x-hidden bg-external-white">
  ...
  <header class="container-fluid background-black-color">
    ...
    <nav class="navbar navbar-expand-lg container py-3">
      <div class="container-fluid">
        <!-- Logo -->
        <a class="navbar-brand text-white fs-1 fw-bold" title="Go to Homepage" href="../index.php">Logi<span class="text-warning">Sync</span></a>
  ...
  <main class="px-2 px-sm-3 px-md-5 pb-5">
    <h3 class="text-center fw-semibold mt-5 font-black p-3 rounded-3">
      Ride with us
      <span class="text-warning background-black-color py-1 px-3 rounded-3">for a top-notch logistics and transport experience!
